...
class BasicBarChart: UIView {
    ...
    private func showEntry(index: Int, entry: BasicBarEntry, animated: Bool, oldEntry: BasicBarEntry?) {
        ...
        mainLayer.addTextLayer(frame: entry.bottomTitleFrame, color: cgColor, fontSize: 8, text: entry.data.title, animated: animated, oldFrame: oldEntry?.bottomTitleFrame)
    }
